# distillation-director · 蒸馏主管（V4.9.16 · 发行自足 ＋ 三闸判态 ＋ §21 强制门禁 ＋ 装机态三层律 ＋ 判据单一来源 ＋ 防坑体系）
...
```
SKILL.md          技能正文（**V4.9.16 权威**；§0–§16 基干 ＋ §17–§25 历次增补）
index.js          插件壳（注册技能）
